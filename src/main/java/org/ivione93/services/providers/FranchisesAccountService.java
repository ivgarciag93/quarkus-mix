...
public class FranchisesAccountService {
  ...
  public AccountBalanceResponse getTotalDebt(final int storeCode, final String fiscalId) {
    AccountBalanceResponse accountBalanceResponse = new AccountBalanceResponse();
    accountBalanceResponse.initBalanceAmount = new BigDecimal("50.0");
    accountBalanceResponse.endBalanceAmount = new BigDecimal("50.0");
    accountBalanceResponse.movements = new ArrayList<>();
